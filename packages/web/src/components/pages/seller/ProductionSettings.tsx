        ...
        <div className="flex items-center justify-center min-h-[60vh]">
          <div className="bg-white rounded-xl shadow-sm border border-line p-8 text-center max-w-md w-full">
            ...
            <button
              ...
              className="bg-brand text-white px-6 py-2.5 rounded-full hover:bg-brand-600 transition-colors duration-200 font-medium shadow-sm"
            >
              {t('common:retry')}
            </button>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="sticky top-0 z-10 p-4 flex justify-end gap-3">
            <button
              ...
              className="bg-white border border-line text-ink px-4 py-2.5 rounded-lg hover:bg-surface transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed font-medium"
            >
              {t('common:reset')}
            </button>
            <button
              ...
              className="bg-brand text-white px-6 py-2.5 rounded-full hover:bg-brand-600 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed font-medium shadow-sm"
            >
              {saving ? (
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted">{t('productionSettings.optimalCapacityDesc')}</p>
                  </div>
                </div>
                ...
                <div className="bg-surface rounded-lg p-4">
                  <div className="flex items-center gap-3">
                    <input
                      ...
                      className="flex-1 border-2 border-line rounded-lg px-4 py-3 text-center text-lg font-semibold focus:border-brand focus:ring-0 transition-colors duration-200"
                      placeholder="10"
                    />
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted">{t('productionSettings.avgProcessingDaysDesc')}</p>
                  </div>
                </div>
                ...
                <div className="bg-surface rounded-lg p-4">
                  <div className="flex items-center justify-center gap-3">
                    <input
                      ...
                      className="w-32 border-2 border-line rounded-lg px-4 py-3 text-center text-lg font-semibold focus:border-orange-500 focus:ring-0 transition-colors duration-200"
                      placeholder="3"
                    />
            ...
            <div className="space-y-4">
              <div className="relative">
                <textarea
                  ...
                  className="w-full border-2 border-line rounded-lg px-4 py-4 h-32 resize-none focus:border-brand focus:ring-0 transition-colors duration-200 placeholder-gray-400"
                  maxLength={500}
                />
